    ...
    if run_foldseek:
        ...
        for r in results:
            if r.get("source") == "esmfold" and r.get("pdb_text"):
                ...
                break
        if pdb_text:
            from biolab.contrib.dnasyn.sources.foldseek import search_foldseek
    ...
    if run_alphafold:
        ...
        for r in results:
            if r.get("source") == "uniprot" and r.get("accession"):
                ...
                break
        if accession:
            from biolab.contrib.dnasyn.sources.alphafold import search_alphafold
