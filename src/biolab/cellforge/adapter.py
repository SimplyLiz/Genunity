...
from biolab.models import CellSpec, CellSpecGene, CellSpecMetabolite, CellSpecReaction
from biolab.cellforge.core.knowledge_base import (
    Gene,
    KnowledgeBase,
    Metabolite,
    Reaction,
...
def knowledge_base_to_cellspec(kb: KnowledgeBase) -> CellSpec:
    ...
    from biolab.models import ReactionParticipant
