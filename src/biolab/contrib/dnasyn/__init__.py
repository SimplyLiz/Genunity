...
Import this module to activate DNASyn sources:
    ...
    import biolab.contrib.dnasyn  # registers all sources

Or selectively:
    from biolab.contrib.dnasyn import register_all
    register_all()
"""
...
def register_all() -> None:
    ...
    from biolab.db.models.evidence import EvidenceType
    from biolab.registry import register_source

    _MOD = "biolab.contrib.dnasyn.sources"
