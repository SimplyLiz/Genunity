"""biolab evidence -- manage evidence sources and batch collection."""
...
def run_cmd(
    ...
    from biolab.pipeline.evidence_runner import run_source
...
def run_all_cmd(
    ...
    from biolab.pipeline.evidence_runner import run_all_sources
...
def status_cmd(
    ...
    from biolab.pipeline.evidence_runner import evidence_status
...
def list_sources_cmd():
    ...
    from biolab.pipeline.evidence_runner import list_sources
