"""biolab analyze -- deep gene analysis CLI commands."""
...
from biolab.services import gene_service, hypothesis_service
...
def deep_cmd(
    ...
    from biolab.services import llm_service
...
def status_cmd():
    ...
    try:
        ...
        from biolab.services.gene_service import genes_without_evidence
