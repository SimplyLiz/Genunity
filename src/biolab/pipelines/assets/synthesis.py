...
from biolab.pipelines.resources import DatabaseResource
from biolab.pipelines.assets.homology import ncbi_blast, hmmer_search, hhpred_search
from biolab.pipelines.assets.structure import esmfold_structures, alphafold_structures, foldseek_search
from biolab.pipelines.assets.context import literature_search, eggnog_annotations, operon_predictions
from biolab.pipelines.assets.localization import deeptmhmm_topology, signalp_predictions
from biolab.pipelines.assets.local_homology import hhblits_search, prost_search
from biolab.pipelines.assets.synwiki_asset import synwiki_annotations
...
def llm_hypothesis_synthesis(context: AssetExecutionContext, database: DatabaseResource):
    ...
    from biolab.services import gene_service, hypothesis_service, llm_service
    from biolab.services.convergence import compute_convergence
    from biolab.services.llm_synthesis import build_evidence_prompt
