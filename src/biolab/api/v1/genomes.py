...
def search_ncbi_genomes(
    ...
    from biolab.services.ncbi_genomes import search_genomes
...
def fetch_ncbi_genome(
    ...
    from biolab.services.ncbi_genomes import fetch_genbank
    from biolab.services.import_service import import_genome_from_text
    from biolab.exceptions import ParseError
...
def genome_hydrate(genome_id: int, db: Session = Depends(get_db)):
    ...
    from biolab.services import gene_service
