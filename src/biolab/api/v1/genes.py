...
from biolab.api.deps import get_db
from biolab.api.v1.schemas import (
    ApproveRequest,
    ConvergenceResponse,
    CorrectRequest,
    DisagreementPairOut,
...
from biolab.exceptions import HypothesisNotFoundError
from biolab.services import gene_service, hypothesis_service, import_service
...
def genome_hydrate(db: Session = Depends(get_db)):
    ...
    """
    from biolab.models import FunctionalCategory, GenomeGene, GenomeRecord
    from biolab.services.genbank import _classify_gene, CATEGORY_COLORS
    from biolab.services.prior_knowledge import lookup
...
def approve_gene(locus_tag: str, body: ApproveRequest, db: Session = Depends(get_db)):
    ...
    if hyp:
        from biolab.db.models.hypothesis import HypothesisStatus
...
def get_research_summary(db: Session = Depends(get_db)):
    ...
    from biolab.db.models.evidence import Evidence
    from biolab.db.models.hypothesis import Hypothesis, HypothesisStatus
