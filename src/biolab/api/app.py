"""BioLab unified FastAPI application — WebSocket streaming + REST CRUD."""
...
from biolab.models import GeneInput, PipelineEvent, StageStatus
from biolab.pipeline.orchestrator import run_pipeline
...
def create_app() -> FastAPI:
    ...
    from biolab.api.v1.router import router as v1_router
    ...
    async def ws_analyze(websocket: WebSocket):
        ...
        try:
            ...
            from biolab.pipeline.persistence import persist_event
            ...
            if "protein_sequence" in data:
                ...
                from biolab.pipeline.stages.functional_prediction import run_single_gene
...
def _register_exception_handlers(app: FastAPI) -> None:
    ...
    from biolab.exceptions import GeneNotFoundError, ParseError, ImportError_, BioLabError
