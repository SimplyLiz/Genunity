...
from biolab.cli.main import app

runner = CliRunner()


@patch("biolab.cli.analyze._SessionLocal")
@patch("biolab.cli.analyze.gene_service")
@patch("biolab.cli.analyze.hypothesis_service")
...
def test_deep_prompt_only(mock_gene_svc, mock_session_cls):
    ...
    with patch("biolab.db.models.evidence.Evidence") as MockEvidence:
...
def test_deep_no_evidence(mock_gene_svc, mock_session_cls):
    ...
    with patch("biolab.db.models.evidence.Evidence"):
