...
from biolab.services.go_validator import (
    is_valid_go_term,
    validate_go_terms,
    reset_go_cache,
)
...
class TestGOValidator:
    def test_no_data_file_accepts_all(self, tmp_path):
        ...
        with patch("biolab.services.go_validator.Path") as mock_path:
        ...
        import biolab.services.go_validator as gov
        gov._loaded = True
        gov._go_ids = None
    ...
    def test_invalid_go_terms_dropped_in_normalizer(self):
        ...
        import biolab.services.go_validator as gov
        from biolab.services.evidence_normalizer import normalize_evidence, reset_keyword_map_cache
