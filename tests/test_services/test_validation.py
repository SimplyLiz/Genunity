...
from biolab.db.models import Evidence, EvidenceType, Gene, Hypothesis
from biolab.db.models.hypothesis import HypothesisScope, HypothesisStatus
from biolab.services.validation_service import (
    _compare_functions,
...
from biolab.services.gene_service import compute_convergence_score
...
class TestLeaveOneOut:
    def test_loo_with_matching_prediction(self, validation_gene):
        ...
        with patch("biolab.services.validation_service.llm_service") as mock_llm:
