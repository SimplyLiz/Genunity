...
def test_synthesize_openai():
    ...
    with patch("biolab.services.llm_service.settings") as mock_settings:
        ...
        with patch("openai.OpenAI", return_value=mock_client):
            from biolab.services.llm_service import synthesize
...
def test_synthesize_ollama():
    with patch("biolab.services.llm_service.settings") as mock_settings:
        ...
        with patch("biolab.services.llm_service.httpx.post", return_value=mock_resp):
            from biolab.services.llm_service import synthesize
